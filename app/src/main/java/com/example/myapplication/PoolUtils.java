...
public class PoolUtils {
    ...
    public static File createGenesisTxnFile(String filename) throws IOException, java.io.IOException {
    ...
    public static void writeTransactions(File file) throws IOException, java.io.IOException {
    ...
    private static void createPoolLedgerConfig(String poolName) throws IOException, InterruptedException, java.util.concurrent.ExecutionException, IndyException {
        ...
        try {
            genesisTxnFile = createGenesisTxnFile("temp.txn");
